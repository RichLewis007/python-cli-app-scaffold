...
echo "  2. Read Next-steps-after-copying-scaffold.md for getting started guide"
echo ""
echo "  Development paths:"
echo ""
echo "  Option A: Local project development (recommended to start)"
echo "    - Run 'uv sync' to set up local .venv and dependencies"
echo "    - Test with: uv run $CMD_NAME --help"
echo "    - Works only in project directory"
echo ""
echo "  Option B: System-wide installation (for development)"
echo "    - Run './install.sh --editable' to install system-wide"
echo "    - Use from anywhere: $CMD_NAME --help"
echo "    - Uses uv's isolated tool environment (separate from project .venv)"
echo ""
echo "  📖 See Next-steps-after-copying-scaffold.md for detailed instructions!"